...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Call<List<UPost>> call = umoriliService.getData("bash", 1);
        ...
        call.enqueue((new Callback<List<UPost>>() {
            ...
            public void onResponse(Call<List<UPost>> call, Response<List<UPost>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        Toast.makeText(com.example.umori.MainActivity.this, errorBody.string(),
            ...
            public void onFailure(Call<List<UPost>> call, Throwable throwable) {
                Toast.makeText(com.example.umori.MainActivity.this, "Что-то пошло не так",
                        Toast.LENGTH_SHORT).show();
                mProgressBar.setVisibility(View.INVISIBLE);
            }
        }));
